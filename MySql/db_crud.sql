...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/metro/css/theme.css?v=5.1.3&nocache=1839578254ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_crud&table=tabel_biodata">`db_crud`.`tabel_biodata`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_auth&table=users">`db_auth`.`users`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="744e245a6045484a69752f6157794c4a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Waktu eksekusi kueri
                            ...
                            targetdb="db_crud" targettable="tabel_biodata">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tabel_biodata`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_crud" targettable="tabel_biodata">
                            <div class="action_content">
